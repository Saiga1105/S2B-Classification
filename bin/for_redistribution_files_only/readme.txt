Classification MATLAB .NET Assembly (.NET Component)
...
Classification_overview.html - HTML overview documentation file for the generated 
                               component. It contains the requirements for accessing the 
                               component and for generating arguments using the MWArray 
                               class hierarchy.

Classification.xml - This file contains the code comments for the Classification 
                               ...
                               documentation for the Classification component.
